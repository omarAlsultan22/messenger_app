...
import 'package:test_app/layouts/view_image_layout.dart';
...
class _EditPersonalAccountLayoutState extends State<EditPersonalAccountLayout> {
  ...
  Widget _buildAvatar() {
    return CircleAvatar(
      radius: avatarRadius,
      backgroundImage: CachedNetworkImageProvider(UserDetails.image),
  ...
  void _viewImage(BuildContext context) {
    navigator(
      context: context,
      link: ViewImageLayout(userImage: UserDetails.image),
    );
  }

  Future<void> _pickImage() async {
    mediaUrl = (await pickImage()) ?? '';
  }
