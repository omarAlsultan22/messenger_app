...
import '../modules/messenger_screen/widgets/chats_list.dart';
import '../modules/messenger_screen/widgets/stories_list.dart';
import '../modules/conversation_screen/conversation_screen.dart';
import '../modules/notification_service/notification_service.dart';
import '../modules/messenger_screen/widgets/messenger_app_bar.dart';
...
class _MessengerLayoutState extends State<MessengerLayout> {
  ...
  void navigateToConversation(LastMessageModel lastMessageModel) {
  ...
  void _navigateToProfile() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EditPersonalAccountScreen(userId: UserDetails.userId),
      ),
    );
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            StoriesList(
              friends: friendList,
              onFriendTap: navigateToConversation,
            ),
            const SizedBox(height: 20.0),
            ChatsList(
              filteredData: _filteredData,
              searchController: _searchController,
              onChatTap: navigateToConversation,
            ),
          ],
        ),
      ),
