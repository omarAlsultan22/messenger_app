...
import '../../../../../core/cubit_states/cubit_states.dart';
...
class _SignInLayoutState extends State<SignInLayout> {
  ...
  Widget _buildPhoneOrEmailField() {
    return TextFormField(
      ...
      decoration: _buildPhoneOrEmailFieldDecoration(),
  ...
  BoxDecoration _buildBackgroundDecoration() {
    return const BoxDecoration(
      image: DecorationImage(
        image: NetworkImage(BackgroundCover.backgroundCover),
        fit: BoxFit.cover,
      ),
    );
  }

  InputDecoration _buildPhoneOrEmailFieldDecoration() {
